...
- **No orders table yet.** The Netlify function logs (`console.log('[place-order]', ...)`) are the audit trail. Search the Netlify dashboard's Functions → place-order → Logs by `orderRef` (e.g. `RC-AB12CD`).
